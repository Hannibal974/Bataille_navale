...
public class PanelGame extends JPanel implements ActionListener
{
	...
	private void initComponents() {
        ...
        jta_historique.append("Trouver le nombre. \n Les règles sont simples. Le serveur crée un nombre aléatoire.\n Vous devez le deviner. Vous avez un adversaire. Le plus rapide l'emporte.\n A vous de jouer!\n");
        l_historique.setText("Historique:");
        tf_nombre.setText("Saisir un Nombre ici");
		...
		if(e.getSource() == b_send)
		{
			if(client.GetNumberPlayers() == 2)
			{
				if (tf_nombre.getText() != "") 
				{
					...
					{
						jta_historique.append("Veuillez saisir un nombre! Merci.\n");
					}
				}
			}
