...
public class PanelConnect extends JPanel implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		{
			System.out.println("Player Asked to join Server");
			...
			System.out.println("Player: " + play.getUsername() + " Asked serveur : " + validation);
			//Changement de panel
			frame.getContentPane().setVisible(false);
			frame.getContentPane().remove(this);
			System.out.println("Go to lobby");
			frame.getContentPane().add(new PanelLobby(client, play, client.GetPortFromServer(),frame));
			frame.getContentPane().setVisible(true);
			}
			catch(Exception e1)
			{
				System.err.println("Wrong Connetion : " + e1.getMessage());
			}
		}
	}
}
