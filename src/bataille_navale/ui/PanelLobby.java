...
public class PanelLobby extends JPanel implements ActionListener
{
	...
	public PanelLobby (Client cli, Player play, String[] listMatchToJoin, MaFrame framish)
	{
		...
		{
			//il faut concatÈner la ligne i et i+1 pour avoir le thread et le nom du joueur sur la mÍme ligne
	 ...
	 private void initComponents() {
	        ...
	        b_connect.setText("Cr√©er une partie");
	        ...
	        l_createParty1.setText("Ou cr√©er une partie:");

	        b_deconnect.setText("Se d√©connecter");
